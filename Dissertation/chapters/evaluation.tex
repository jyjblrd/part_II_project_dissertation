...
%         \caption{EuRoC Machine Hall 01-03 estimated trajectory and ground truth. \comment{TODO: split up by agent somehow?}}
%         \label{fig:euroc-traj}
%     \end{minipage}\hfill%
%     ~
%     \begin{minipage}[t]{0.45\linewidth}
...
\begin{figure}[h]
    ...
    \begin{minipage}[b]{0.62\linewidth}
        ...
        \caption{Plot of ground truth distance between the two robots throughout all four collision avoidance trials conducted in the intersection environment. The dips between trials are the robots' positions being reset. \autoref{fig:collision-avoidance} visualizes Trial 4 in more detail.\captionbreak For visual reference, a video recording of the four trials is available at 1m23s \comment{TODO} of the supplementary video\protect\footnotemark[1] \comment{TODO:footnote}.}
