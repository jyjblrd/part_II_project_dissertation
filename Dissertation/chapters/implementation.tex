...
Keyframes also have a ``visual words" representation, which are vectors describing the visual contents of the keyframe. These are essential for detecting potential map merges, so we also build a ``visual word set" that allows us to find all keyframes that contain a particular visual word.
...
\begin{minipage}{\linewidth}
    \dirtree{%
        .1 part\_ii\_project/.
        .2 src/\DTcomment{\locdiff{1,000}{1,000}{\locindent}}.
        .3 orb\_slam3\_ros/\DTcomment{Core SLAM package\locdiff{1,000}{1,000}{\locindent}}.
        .5 configs/\DTcomment{Config for different camera systems\locdoublespace{\locindent}}.
        .5 src/\DTcomment{Source code for my SLAM system\locadd{1,351}{\locindent}}.
        .5 orb\_slam3/\DTcomment{Heavily modified ORB-SLAM3 codebase\locdiff{1,000}{1,000}{\locindent}}.
        .4 ....
        .3 motion\_controller/\DTcomment{Motion controller package\locdoublespace{\locindent}}.
        .4 motion\_controller/\DTcomment{\locadd{615}{\locindent}}.
        .5 collision\_avoidance.py\DTcomment{\locadd{142}{\locindent}}.
        .5 follow\_the\_leader.py\DTcomment{\locadd{78}{\locindent}}.
        .5 helpers/\DTcomment{\locadd{325}{\locindent}}.
        .4 ....
        .3 webots\_sim/\DTcomment{\locadd{276}{\locindent}}.
        .4 launch/robot\_launch.py\DTcomment{\locadd{42}{\locindent}}.
        .4 webots\_sim/robot\_driver.py\DTcomment{\locadd{58}{\locindent}}.
        .4 worlds/\DTcomment{Simulation environments\locdoublespace{\locindent}}.
        .4 ....
        .3 controller/\DTcomment{Centeral management interface package\locadd{442}{\locindent}}.
        .3 evaluation/\DTcomment{Jupyter Notebooks for evaluation\locadd{10}{\locindent}}.
        .3 interfaces/\DTcomment{Custom ROS message type definitions\locadd{10}{\locindent}}.
        .3 tools/\DTcomment{Misc. scripts\locadd{10}{\locindent}}.
        .2 .github/workflows/config.yml\DTcomment{CI/CD configuration\locadd{73}{\locindent}}.
        .2 Dockerfile\DTcomment{Main dockerfile for the project\locadd{20}{\locindent}}.
        .2 nvidia\_jetson.Dockerfile\DTcomment{Dockerfile for the NVidia Jetson\locadd{30}{\locindent}}.
        .2 ....
    }
\end{minipage}

The \texttt{rpi\_ros2\_camera\_publisher} repository contains the code and CI/CD configuration for the Raspberry Pi Video Publisher.

\begin{minipage}{\linewidth}
    \dirtree{%
        .1 rpi\_ros2\_camera\_publisher/\DTcomment{\locaddnospace{190}{\locsmallindent}}.
        .2 src/.
...
The \texttt{multi\_agent\_evo} repository is a fork of the EVO library and is used to evaluate multi-agent SLAM systems. The changes made to EVO are shown below.

\begin{minipage}{\linewidth}
    \dirtree{%
        .1 multi\_agent\_evo/\DTcomment{\locdiff{317}{21}{\locsmallindent}}.
        .2 evo/.
        .3 core/\DTcomment{\locdiff{126}{5}{\locsmallindent}}.
        .3 tools/\DTcomment{\locdiff{189}{16}{\locsmallindent}}.
        .2 ....
    }
\end{minipage}
