...
As explained in the \nameref{sec:cicd} section, the software for this platform is entirely dockerized and a CI/CD pipeline has been implemented to automatically build and deploy the software to all Raspberry Pi video publishers when new code is pushed to the GitHub repository.
...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \dirtree{%
            ...
            .2 Dockerfile\DTcomment{Main dockerfile for the project (\cref{sec:docker-containers})\locaddnospace{20}{\locindent}}.
            .2 nvidia\_jetson.Dockerfile\DTcomment{Dockerfile for the NVidia Jetson (\cref{sec:docker-containers})\locaddnospace{30}{\locindent}}.
            .2 ....
        }
    \end{minipage}
...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{\linewidth}
        ...
        \dirtree{%
            ...
            .2 3D\_files/.
            .2 Dockerfile\DTcomment{Main dockerfile for the project (\cref{sec:docker-containers})\locaddnospace{10}{\locsmallindent}}.
